    ...
    <header class="sticky top-0 z-40 border-b border-white/70 bg-[#f7f8fc]/80 backdrop-blur dark:border-white/10 dark:bg-slate-950/75">
      <nav class="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <div class="hidden items-center gap-10 text-sm text-slate-600 dark:text-slate-300 lg:flex">
          ...
          <a href="#risk" class="transition-colors hover:text-slate-900 dark:hover:text-white">Risks</a>
      ...
      <transition name="fade">
        ...
        >
          <nav class="flex flex-col gap-4">
            ...
            <a href="#risk" class="transition-colors hover:text-slate-900 dark:text-slate-300 dark:hover:text-white" @click="closeMobile">Risks</a>
        ...
        <div class="mx-auto flex max-w-5xl flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
          <div class="space-y-4 lg:w-1/3" data-animate="fade">
            ...
            <p class="text-base leading-relaxed text-slate-600 dark:text-slate-300">
              Business downtime is costly. Pipebudi helps you act fast on leaks so teams keep trading without unnecessary stress.
            </p>
          </div>
          <div class="grid flex-1 gap-6 md:grid-cols-2" data-animate="fade" style="--delay: 120ms">
            <div class="rounded-3xl border border-slate-200/80 bg-white/80 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:bg-slate-900/60">
              <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Metered awareness</h3>
              <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                Over recent times there has been an increased focus by water companies to install more water meters, with Ofwat allocating £1.7bn to assist in the installation of smart meters to help detect continuous flows and leaks.
              </p>
            </div>
            <div class="rounded-3xl border border-slate-200/80 bg-white/80 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:bg-slate-900/60">
              <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Monthly risk reality</h3>
              <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                Throughout Europe it is reported that 1 in 3 commercial buildings experience some sort of monthly water leak - which can have significant financial implications in terms of damage costs, rises in insurance premiums and excess costs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="cta" class="px-6 py-20">
        <div class="mx-auto max-w-5xl overflow-hidden rounded-[32px] border border-slate-200/70 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 text-white shadow-[0_30px_120px_-70px_rgba(15,23,42,0.65)] dark:border-white/10 dark:from-white dark:via-slate-100 dark:to-white dark:text-slate-900">
          <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div class="space-y-3">
              <p class="text-sm font-semibold uppercase tracking-[0.3em] text-white/70 dark:text-slate-700">Business-ready protection</p>
              <h2 class="text-3xl font-semibold leading-tight">Mitigating against these risks is key.</h2>
              <p class="max-w-2xl text-base leading-relaxed text-white/80 dark:text-slate-700">
                Manage water consumption and prevent catastrophic leaks so your team can keep serving customers without interruption.
              </p>
            </div>
            <div class="flex flex-col gap-3 md:items-end">
              ...
              <p class="text-xs text-white/70 dark:text-slate-600">Stay ahead of costly downtime and damage.</p>
            </div>
          </div>
        </div>
      </section>
...
useHead({
  title: 'Pipebudi for Commercial Properties | Keep trading without leaks',
  meta: [
    {
      name: 'description',
      content:
        'Protect barbers, cafes, salons, and restaurants from water damage with Pipebudi—remote shutoff and monitoring that fits modern teams.',
    },
    {
      property: 'og:title',
      content: 'Pipebudi for Commercial Properties | Keep trading without leaks',
    },
    {
      property: 'og:description',
      content:
        'Avoid downtime and costly damage with Pipebudi’s leak detection, smart-meter awareness, and business-friendly controls.',
    },
  ],
  link: [
    {
