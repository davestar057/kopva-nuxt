    ...
    <header class="sticky top-0 z-40 border-b border-white/70 bg-[#f7f8fc]/80 backdrop-blur dark:border-white/10 dark:bg-slate-950/75">
      <nav class="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <div class="hidden items-center gap-10 text-sm text-slate-600 dark:text-slate-300 lg:flex">
          ...
          <a href="#guidance" class="transition-colors hover:text-slate-900 dark:hover:text-white">Guidance</a>
      ...
      <transition name="fade">
        ...
        >
          <nav class="flex flex-col gap-4">
            ...
            <a href="#guidance" class="transition-colors hover:text-slate-900 dark:text-slate-300 dark:hover:text-white" @click="closeMobile">Guidance</a>
        ...
        <div class="relative mx-auto max-w-6xl overflow-hidden rounded-[36px] border border-white/60 bg-white/80 px-8 py-12 shadow-[0_30px_140px_-80px_rgba(15,23,42,0.35)] backdrop-blur-lg dark:border-white/10 dark:bg-slate-950/60">
          ...
          <div class="relative grid items-start gap-10 lg:grid-cols-[1.05fr_0.95fr]" data-animate="fade">
            ...
            <div class="space-y-4 rounded-3xl border border-white/60 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/70">
              <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Holiday stays stay safe</h2>
              <p class="text-base leading-relaxed text-slate-600 dark:text-slate-300">
                Long gaps and new guests make leaks easy to miss. Pipebudi blends into the background so you can calm winter risks, give guests clear controls, and keep every turnover protected.
              </p>
              <ul class="grid gap-3 text-sm font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-200 sm:grid-cols-2">
                <li class="rounded-2xl border border-white/60 bg-white/80 px-4 py-3 dark:border-white/10 dark:bg-white/5">Empty weeks covered</li>
                <li class="rounded-2xl border border-white/60 bg-white/80 px-4 py-3 dark:border-white/10 dark:bg-white/5">Guest-ready guidance</li>
                <li class="rounded-2xl border border-white/60 bg-white/80 px-4 py-3 dark:border-white/10 dark:bg-white/5">Freeze-season alerts</li>
      ...
      <section id="cta" class="px-6 py-20">
        <div class="mx-auto max-w-5xl overflow-hidden rounded-[32px] border border-slate-200/70 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 text-white shadow-[0_30px_120px_-70px_rgba(15,23,42,0.65)] dark:border-white/10 dark:from-white dark:via-slate-100 dark:to-white dark:text-slate-900">
          <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div class="space-y-3">
              <p class="text-sm font-semibold uppercase tracking-[0.3em] text-white/70 dark:text-slate-700">Always ready</p>
              <h2 class="text-3xl font-semibold leading-tight">Reduce the risk of a leak even when your holiday home is empty.</h2>
              <p class="max-w-2xl text-base leading-relaxed text-white/80 dark:text-slate-700">
                Pipebudi keeps water calm between visits so you and your guests arrive to a property that is serene, dry, and ready.
              </p>
            </div>
            <div class="flex flex-col gap-3 md:items-end">
              ...
              <p class="text-xs text-white/70 dark:text-slate-600">Stay ahead of frozen pipes and unnoticed leaks.</p>
            </div>
          </div>
        </div>
      </section>
...
useHead({
  title: 'Pipebudi for Holiday Homes | Calm protection between every guest',
  meta: [
    {
      name: 'description',
      content:
        'Keep holiday homes dry between stays with Pipebudi—remote shutoff, frost awareness, and guidance that keeps guests prepared.',
    },
    {
      property: 'og:title',
      content: 'Pipebudi for Holiday Homes | Calm protection between every guest',
    },
    {
      property: 'og:description',
      content:
        'Avoid burst pipes and unnoticed leaks in second homes with Pipebudi’s remote-first leak detection and guest-ready controls.',
    },
  ],
  link: [
    {
