    ...
    <main>
          ...
          <div class="space-y-6 lg:space-y-8" data-animate="fade">
            ...
            <div class="space-y-5">
              <h1 id="hero-title" class="text-4xl font-semibold leading-tight tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl">
                Keep your holiday home protected between every stay.
              </h1>
              <p class="max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                Pipebudi gives second-home owners a modern, remote-first way to prevent leaks before they become claims—whether the property is empty in winter or welcoming guests in summer.
              </p>
            </div>
            <div class="flex flex-col gap-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              <p>
                Escape of water is the most common claim in second homes, with almost 50% of incidents linked to burst pipes. Pipebudi keeps your retreat calm with instant alerts, remote shutoff, and frost awareness.
              </p>
              <p>
                With protection designed for unoccupied periods and guest-friendly controls, you reduce costly repairs, lost bookings, and disruption for every stay.
              </p>
            </div>
              ...
              <div class="relative h-full rounded-[24px] bg-gradient-to-br from-white/8 via-slate-900/70 to-slate-950/80 p-4 backdrop-blur">
                ...
                <div class="overflow-hidden rounded-2xl border border-white/20 bg-white/5 shadow-inner">
                  <img
                      ...
                      alt="Relaxed holiday home interior"
                ...
                <div class="mt-4 flex flex-col gap-2 rounded-2xl border border-white/15 bg-white/5 p-4 text-slate-100">
                  <p class="text-xs uppercase tracking-[0.3em] text-slate-300">For modern retreats</p>
                  <p class="text-base font-semibold text-white">A calm, getaway-ready feel that blends with light or dark mode.</p>
                  <p class="text-sm text-slate-200">Use Pipebudi to keep your holiday home protected between guests.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="benefits" class="mx-auto max-w-6xl px-6 pb-24">
        <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between" data-animate="fade">
          <div>
            <p class="text-sm font-semibold uppercase tracking-[0.4em] text-slate-500 dark:text-slate-400">Purpose-built for second homes</p>
            <h2 class="mt-4 text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Effortless oversight between visits</h2>
          </div>
          <p class="max-w-xl text-base text-slate-600 dark:text-slate-300">
            Keep your retreat ready with proactive monitoring, simple controls, and alerts that respect your time.
          </p>
        </div>
        <div class="mt-10 grid gap-5 md:grid-cols-3">
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Empty-week peace</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Guard long gaps</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Keep the property safe during long winter breaks with proactive alerts and automatic shutoff before leaks spread.
            </p>
          </article>
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Winter ready</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Prevent frozen pipes</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Monitor temperatures and flows so frozen pipes don&apos;t turn into 50% of second-home claims.
            </p>
          </article>
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Guest friendly</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Share simple guidance</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Give guests clear controls and instructions so they know how to respond and who to call if there&apos;s a leak.
            </p>
          </article>
        </div>
      </section>
      ...
      <section id="why" class="bg-white/80 py-24 dark:bg-slate-950/60">
        <div class="mx-auto grid max-w-6xl gap-14 px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div class="space-y-6" data-animate="fade">
            ...
            <h2 class="text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Keep every stay stress-free</h2>
            <p class="text-lg text-slate-600 dark:text-slate-300">
              Holiday homes can sit empty for weeks, letting leaks go undetected and causing untold damage. Frozen pipes and constant guest turnover make proactive protection essential.
            </p>
            <div class="grid gap-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              <p>
                Pipebudi monitors flow during unoccupied periods, lets owners and guests turn water off from anywhere, and helps mitigate frozen pipes when temperatures drop.
              </p>
              <p>
                Provide guests with clear guidance on stop taps, what to do if there is a leak, and emergency contact details so every stay remains smooth.
              </p>
            </div>
          </div>
          <div class="rounded-[32px] border border-slate-200/70 bg-white/90 p-10 shadow-[0_40px_120px_-90px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-slate-900/85 dark:shadow-[0_40px_120px_-90px_rgba(15,23,42,0.85)]" data-animate="slide-left">
            <ul class="space-y-4 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              <li class="flex items-start gap-3">
                ...
                Monitor a property that might sit empty for weeks at a time.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-purple-400"></span>
                Use remote shutoff to prevent burst pipes from causing half of second-home claims.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-emerald-400"></span>
                Keep guests informed with clear instructions on what to do if there&apos;s a leak.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-amber-400"></span>
                Leverage temperature awareness to avoid frozen-pipe damage in winter months.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-slate-400"></span>
                Simple setup with Wi‑Fi connectivity and backup battery support for remote properties.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="offer" class="mx-auto max-w-4xl px-6 pb-28 pt-12" data-animate="fade">
        <div class="rounded-[40px] border border-white/80 bg-gradient-to-br from-white via-slate-50 to-sky-100/60 p-16 text-center shadow-[0_60px_160px_-90px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900/95 dark:to-slate-900/80 dark:shadow-[0_60px_160px_-90px_rgba(15,23,42,0.9)]">
          ...
          <h2 class="mt-4 text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Protect your holiday home with 20% off</h2>
...
useHead({
  title: 'Pipebudi for Holiday Homes | Calm protection between every stay',
  meta: [
    {
      name: 'description',
      content:
        'Protect holiday homes from leaks with remote shutoff, frost awareness, and continuous monitoring tailored to empty weeks and frequent guests.',
    },
    {
      property: 'og:title',
      content: 'Pipebudi for Holiday Homes | Calm protection between every stay',
    },
    {
      property: 'og:description',
      content:
        'Leak protection for second homes with proactive alerts, remote valve control, and guest-friendly guidance to prevent catastrophic damage.',
    },
  ],
  link: [
    {
