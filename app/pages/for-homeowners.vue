    ...
    <main>
          ...
          <div class="space-y-6 lg:space-y-8" data-animate="fade">
            ...
            <div class="space-y-5">
              <h1 id="hero-title" class="text-4xl font-semibold leading-tight tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl">
                Keep your home calm, dry, and protected from escape of water.
              </h1>
              <p class="max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                Pipebudi gives homeowners a modern, remote-first way to prevent leaks before they become claims—whether you are home, away for the weekend, or travelling long-term.
              </p>
            </div>
            <div class="flex flex-col gap-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              <p>
                Escape of water is the single biggest home insurance claim category in the UK—over one in three claims in 2024. Pipebudi keeps your space calm with instant alerts, remote shutoff, and frost awareness.
              </p>
              <p>
                From a burst pipe that can leak 30 litres a minute to slow drips that ruin sentimental items, you reduce costly repairs and heartache with proactive protection.
              </p>
            </div>
            ...
            <div class="relative overflow-hidden rounded-[28px] border border-white/70 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-1 shadow-[0_32px_110px_-70px_rgba(15,23,42,0.7)] dark:border-white/10">
              <div class="relative h-full rounded-[24px] bg-gradient-to-br from-white/8 via-slate-900/70 to-slate-950/80 p-4 backdrop-blur">
                ...
                <div class="mt-4 flex flex-col gap-2 rounded-2xl border border-white/15 bg-white/5 p-4 text-slate-100">
                  <p class="text-xs uppercase tracking-[0.3em] text-slate-300">For modern homes</p>
                  <p class="text-base font-semibold text-white">A calm living space that blends with light or dark mode.</p>
                  <p class="text-sm text-slate-200">Use Pipebudi to keep your home protected without hovering over it.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="benefits" class="mx-auto max-w-6xl px-6 pb-24">
        <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between" data-animate="fade">
          <div>
            <p class="text-sm font-semibold uppercase tracking-[0.4em] text-slate-500 dark:text-slate-400">Purpose-built for homes</p>
            <h2 class="mt-4 text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Effortless peace of mind, even when you&apos;re away</h2>
          </div>
          <p class="max-w-xl text-base text-slate-600 dark:text-slate-300">
            Keep your home protected with proactive monitoring, simple controls, and alerts that respect your time.
          </p>
        </div>
        <div class="mt-10 grid gap-5 md:grid-cols-3">
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Stop leaks fast</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Catch issues early</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Receive immediate alerts when something is off so you can shut water off and stop damage before it spreads.
            </p>
          </article>
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Protect what matters</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Safeguard sentimental items</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Prevent burst pipes from destroying irreplaceable possessions with proactive shutoff and temperature awareness.
            </p>
          </article>
          <article class="group relative overflow-hidden rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_28px_80px_-64px_rgba(15,23,42,0.55)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_36px_100px_-64px_rgba(15,23,42,0.6)] dark:border-white/10 dark:bg-slate-950/70">
            <p class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-300">Remote calm</p>
            <h3 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">Control water from anywhere</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              Turn water off from your phone, set it to close automatically, and feel confident whether you are home or away.
            </p>
          </article>
        </div>
      </section>
      ...
      <section id="why" class="bg-white/80 py-24 dark:bg-slate-950/60">
        <div class="mx-auto grid max-w-6xl gap-14 px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div class="space-y-6" data-animate="fade">
            ...
            <h2 class="text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Avoid escape of water stress</h2>
            <p class="text-lg text-slate-600 dark:text-slate-300">
              Escape of water accounts for almost one in three UK home insurance claims and costs insurers £1.8m every day. Preventing and minimising a leak protects your home and the things that matter most.
            </p>
            <div class="grid gap-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              <p>
                Pipebudi monitors flow continuously, lets you turn water off from anywhere, and helps mitigate frozen pipes when temperatures drop.
              </p>
              <p>
                Small habits matter too—know your stopcock, test it regularly, use professionals for plumbing, and keep an eye on hidden drips.
              </p>
            </div>
          </div>
          <div class="rounded-[32px] border border-slate-200/70 bg-white/90 p-10 shadow-[0_40px_120px_-90px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-slate-900/85 dark:shadow-[0_40px_120px_-90px_rgba(15,23,42,0.85)]" data-animate="slide-left">
            <ul class="space-y-4 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
              <li class="flex items-start gap-3">
                ...
                Know where your stopcock is and test it regularly.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-purple-400"></span>
                Understand where pipes run before any DIY or drilling.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-emerald-400"></span>
                Fit a leak detection device like Pipebudi that can shut off water automatically.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-amber-400"></span>
                Use qualified professionals for new plumbing appliances and check for small, hidden drips.
              </li>
              <li class="flex items-start gap-3">
                <span class="mt-1 h-2 w-2 rounded-full bg-slate-400"></span>
                Heat the property during longer absences to prevent frozen pipes and review insurance exclusions for empty periods.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="offer" class="mx-auto max-w-4xl px-6 pb-28 pt-12" data-animate="fade">
        <div class="rounded-[40px] border border-white/80 bg-gradient-to-br from-white via-slate-50 to-sky-100/60 p-16 text-center shadow-[0_60px_160px_-90px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900/95 dark:to-slate-900/80 dark:shadow-[0_60px_160px_-90px_rgba(15,23,42,0.9)]">
          ...
          <h2 class="mt-4 text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">Protect your home with 20% off</h2>
...
useHead({
  title: 'Pipebudi for Homeowners | Calm, modern escape of water protection',
  meta: [
    {
      name: 'description',
      content:
        'Protect your home from escape of water with remote shutoff, frost awareness, and continuous monitoring that keeps sentimental items safe.',
    },
    {
      property: 'og:title',
      content: 'Pipebudi for Homeowners | Calm, modern escape of water protection',
    },
    {
      property: 'og:description',
      content:
        'Homeowner-first leak protection with proactive alerts, remote valve control, and guidance to prevent catastrophic damage or loss.',
    },
  ],
  link: [
    {
